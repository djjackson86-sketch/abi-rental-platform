...
- **Exposure check (good news):** `git log -S <the real plate> origin/master` is **EMPTY** — these identifiers were never pushed. They exist only in this branch's 15 unpushed commits.
